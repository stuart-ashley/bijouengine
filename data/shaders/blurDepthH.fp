...
void main()
{
	float blurSize = u_blurSize / SrcDimensions.x;

	float sum = 0.;
	sum += tap( vec2( v_uv.x - 7.0 * blurSize, v_uv.y ) ) * 0.0122583126287;
	sum += tap( vec2( v_uv.x - 6.0 * blurSize, v_uv.y ) ) * 0.0228821835736;
	sum += tap( vec2( v_uv.x - 5.0 * blurSize, v_uv.y ) ) * 0.0386136847805;
	sum += tap( vec2( v_uv.x - 4.0 * blurSize, v_uv.y ) ) * 0.0590562237819;
	sum += tap( vec2( v_uv.x - 3.0 * blurSize, v_uv.y ) ) * 0.0820225330304;
	sum += tap( vec2( v_uv.x - 2.0 * blurSize, v_uv.y ) ) * 0.103607410144;
	sum += tap( vec2( v_uv.x - 1.0 * blurSize, v_uv.y ) ) * 0.119148521665;
	sum += tap( vec2( v_uv.x - 0.0 * blurSize, v_uv.y ) ) * 0.124822260792;
	sum += tap( vec2( v_uv.x + 1.0 * blurSize, v_uv.y ) ) * 0.119148521665;
	sum += tap( vec2( v_uv.x + 2.0 * blurSize, v_uv.y ) ) * 0.103607410144;
	sum += tap( vec2( v_uv.x + 3.0 * blurSize, v_uv.y ) ) * 0.0820225330304;
	sum += tap( vec2( v_uv.x + 4.0 * blurSize, v_uv.y ) ) * 0.0590562237819;
